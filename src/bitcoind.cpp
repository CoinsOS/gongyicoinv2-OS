...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("GongYiCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  gongyicoind [options]                     " + "\n" +
                  "  gongyicoind [options] <command> [params]  " + _("Send command to -server or gongyicoind") + "\n" +
                  "  gongyicoind [options] help                " + _("List commands") + "\n" +
                  "  gongyicoind [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "gongyicoin:"))
                fCommandLine = true;
...
int main(int argc, char* argv[])
{
    ...
    // Connect gongyicoind signal handlers
    noui_connect();

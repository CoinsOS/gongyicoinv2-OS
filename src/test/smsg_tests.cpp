...
// test_gongyicoin --log_level=all  --run_test=smsg_tests
...
BOOST_AUTO_TEST_CASE(smsg_test)
{
    ...
    const std::string sTestMessage =
        "GongYiCoin is a STATE OF THE ART, Proof of Stake crypto currency, utilizing cutting edge technology, "
        "such as instant p2p encrypted messaging (GongYiCoinChat), and anonymous dual-key stealth addresses (GongYiCoinSend). "

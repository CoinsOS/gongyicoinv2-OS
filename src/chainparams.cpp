...
int64_t CChainParams::GetProofOfWorkReward(int nHeight, int64_t nFees) const
{
    ...
    if (nHeight == 1)
        nSubsidy = (NetworkID() == CChainParams::TESTNET ? 1000000 : 22042748) * COIN;
    else
        nSubsidy = 0 * COIN;
...
int64_t CChainParams::GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees) const
{
    ...
    if (IsProtocolV3(pindexPrev->nHeight))
        nSubsidy = (pindexPrev->nMoneySupply / COIN) * 1.5 * COIN_YEAR_REWARD / (365 * 24 * (60 * 60 / 64));
    else
...
public:
    CBaseChainParams() {
const char* pszTimestamp = "Oct 10 2016, The GongYiCoin was re-created, wish is a great Coin...";
        CTransaction txNew;
        ...
        vSeeds.push_back(CDNSSeedData("139.129.109.126",  "139.129.109.126"));
        vSeeds.push_back(CDNSSeedData("47.89.39.219",  "47.89.39.219"));
        vSeeds.push_back(CDNSSeedData("47.90.41.66",  "47.90.41.66"));
        vSeeds.push_back(CDNSSeedData("47.89.47.122",  "47.89.47.122"));
        vSeeds.push_back(CDNSSeedData("47.90.9.187",  "47.90.9.187"));
    }
...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("0322334ef92b2d59943e57aaa8b1adbb110ff215fc4ebdc6fb5c9a797e2b1dea527");
        ...
        genesis.nNonce   = 28886;
        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x000007c884b90723abd8d738b9cfc39cad89a482e15ed885df496d60c2a69b30"));
        assert(genesis.hashMerkleRoot == uint256("0x5fb66ea490ed0e3ef491d2a3e263f4d6255c78efba2855f12993c070a8a5cdb1"));

        base58Prefixes[PUBKEY_ADDRESS]      = list_of(38).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[SCRIPT_ADDRESS]      = list_of(98).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[SECRET_KEY]          = list_of(191).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[STEALTH_ADDRESS]     = list_of(31).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams() {
        ...
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 49111;
        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x0000c8fd02f6569178807450fc08817dbe41f7654a4ef735569226cbdadf75d4"));
...
public:
    CRegTestParams() {
        ...
        assert(hashGenesisBlock == uint256("0x057292e176f2faae2b8965aa780023e22df2f3a9082aaa176accc5db5669a58d"));
